...
public class DesktopSearchService {
  ...
  public void search(WebDriver driver) {
    ...
    new WebDriverWait(driver, WEB_DRIVER_WAIT_SHORT)
        .until(ExpectedConditions.visibilityOfElementLocated(By.id("id_l")))
        .click();
    searchService.search(driver, bingConfig.getDesktopSearchCount());
  }
}
